...
\preambulo{Trabalho apresentado com o objetivo de aquisição de nota parcial na disciplina de Recursos Humanos do curso de Análise e Desenvolvimento de Sistemas do IFSP - Instituto de Educação, Ciência e Tecnologia de São Paulo.}
...
\input{textos-sobre-inquesti}
\input{textos-mecanismos-recrutamento-selecao-contratacao}
\input{textos-analise-mecanismos-recrutamento-selecao-contratacao}
\input{textos-consideracoes-finais}
% ----------------------------------------------------------
